(self["webpackChunkwebpack_mobile"] = self["webpackChunkwebpack_mobile"] || []).push([[2474],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ ListViewWidget)
});
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/ListView/template.ts
/* harmony default export */ const template = ({type:'string',data:'data',instances:'number',rowKeys:'array',showSeparator:'string'});
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/ListView/widgetRuntimeOptions.ts
/* harmony default export */ const widgetRuntimeOptions = ((0,registry.registerMobile)({typeKey:'RNListViewWidget',name:'ListView',template: template,events:[],propertyAnnotations:{type:{updatesSync:['instances']},data:{updatesSync:['instances']},instances:{computeValueOverride:({model,renderedValue})=>{const type=model.type;if(type==='data'){var _ref;const data=(_ref=model.data)!==null&&_ref!==void 0?_ref:[];return data.length;}else{return renderedValue;}}}}}));
...
;// CONCATENATED MODULE: ./src/components/plugins/widgets/ListView/ListView.tsx
function ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function _objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}const RNListView=({instances,rgProps})=>{const{children}=rgProps;const adjustedChildrenList=(0,react.useMemo)(()=>lodash_default().range(instances).map(rowIndex=>children.map(child=>{return _objectSpread(_objectSpread({},child),{},{instance:rowIndex});})),[instances,children]);const initialNumToRender=adjustedChildrenList.length>40?25:adjustedChildrenList.length;return (0,jsx_runtime.jsx)(FlatList["default"],{data:adjustedChildrenList,initialNumToRender:initialNumToRender,renderItem:({item,index})=>{return (0,jsx_runtime.jsx)(View["default"],{children:item.map((widget,widgetIndex)=>(0,jsx_runtime.jsx)(View["default"],{children:(0,mobileWidget.renderMobileWidgetNode)(widget,widget.instance)},`${index}-${widgetIndex}`))},`${index}`);},keyExtractor:(item,index)=>`${index}`});};/* harmony default export */ const ListView = (RNListView);
;// CONCATENATED MODULE: ./src/components/plugins/widgets/ListView/ListViewWidget.tsx
const _excluded=["bodyGrid"];function ListViewWidget_ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function ListViewWidget_objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?ListViewWidget_ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):ListViewWidget_ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}/* harmony default export */ const ListViewWidget = ((0,connectMobileWidget["default"])(widgetRuntimeOptions.typeKey,ListView,widgetRuntimeOptions,{},_ref=>{let{bodyGrid}=_ref,rest=(0,objectWithoutProperties["default"])(_ref,_excluded);return ListViewWidget_objectSpread(ListViewWidget_objectSpread({},rest),{},{children:bodyGrid});}));
...
//# sourceMappingURL=2474.c880d652.chunk.js.map