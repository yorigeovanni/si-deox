(self["webpackChunkwebpack_mobile"] = self["webpackChunkwebpack_mobile"] || []).push([[9793],{
...
var Easing = __webpack_require__(969376);
...
var I18nManager = __webpack_require__(779101);
...
var useColorScheme = __webpack_require__(38733);
...
var colorUtils = __webpack_require__(730507);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ SegmentedControlWidget)
});
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/SegmentedControl/template.ts
function ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function _objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}/* harmony default export */ const template = (_objectSpread(_objectSpread({},commonTemplates.formFieldTemplate),{},{label:'string',labelCaption:'string',labels:'string[]',value:'primitive',values:'array',disabled:'boolean'}));
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/SegmentedControl/widgetRuntimeOptions.ts
/* harmony default export */ const widgetRuntimeOptions = ((0,registry.registerMobile)({typeKey:'RNSegmentedControlWidget',name:'SegmentedControl',template: template,events:['change'],formFieldType:'mobile'}));
...
var SegmentedControl = __webpack_require__(9723);
;// CONCATENATED MODULE: ./src/components/plugins/widgets/SegmentedControl/SegmentedControlWidget.tsx
const _excluded=["onChange","updateModel"];function SegmentedControlWidget_ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function SegmentedControlWidget_objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?SegmentedControlWidget_ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):SegmentedControlWidget_ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}/* harmony default export */ const SegmentedControlWidget = ((0,connectMobileWidget["default"])(widgetRuntimeOptions.typeKey,SegmentedControl["default"],widgetRuntimeOptions,{},_ref=>{let{onChange,updateModel}=_ref,rest=(0,objectWithoutProperties["default"])(_ref,_excluded);return SegmentedControlWidget_objectSpread(SegmentedControlWidget_objectSpread({},rest),{},{onChange:value=>{updateModel({value});onChange===null||onChange===void 0?void 0:onChange();}});}));
...
//# sourceMappingURL=9793.cf0dad6b.chunk.js.map