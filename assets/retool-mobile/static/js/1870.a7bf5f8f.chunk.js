(self["webpackChunkwebpack_mobile"] = self["webpackChunkwebpack_mobile"] || []).push([[1870],{
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ CollectionViewWidget)
});
...
// EXTERNAL MODULE: ../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js
var react = __webpack_require__(985707);
;// CONCATENATED MODULE: ../frontend/src/assets/widget-icons-2/listView.svg
var _rect, _path;
...
function SvgListView(props) {
  return /*#__PURE__*/react.createElement("svg", _extends({
    ...
    d: "M8 10v5a2 2 0 002 2h28a2 2 0 002-2v-5a2 2 0 00-2-2H10a2 2 0 00-2 2zm0 12v5a2 2 0 002 2h28a2 2 0 002-2v-5a2 2 0 00-2-2H10a2 2 0 00-2 2zm0 12v5a2 2 0 002 2h28a2 2 0 002-2v-5a2 2 0 00-2-2H10a2 2 0 00-2 2z",
    fill: "#EEE"
  })));
}
/* harmony default export */ const listView = (SvgListView);
;// CONCATENATED MODULE: ../frontend/src/assets/widget-icons-mobile/list.svg
var list_path;
...
function SvgList(props) {
  return /*#__PURE__*/react.createElement("svg", list_extends({
    width: 16,
    height: 17,
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, props), list_path || (list_path = /*#__PURE__*/react.createElement("path", {
    d: "M5.333 4.5H14M5.333 8.5H14M5.333 12.5H14M2 4.5h.007M2 8.5h.007M2 12.5h.007",
    stroke: "#B3B3B3",
    strokeWidth: 1.5,
    strokeLinecap: "round",
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/CollectionView/presets.ts
const tableDataTemplate=`[{
  ...
  "sales": 243
}]`;const itemTemplate={title:'{{entry.name}}',subtitle:'{{entry.email}}',body:'{{entry.sales}}',suffixComponentType:'none',suffixIcon:'bold/interface-arrows-button-right',suffixSwitchValue:'false',prefixComponentType:'image',prefixIcon:'bold/interface-user-single',prefixImageSource:'',prefixImageSize:'small',prefixImageStyle:'round',prefixCheckboxValue:'false'};const presets=[{name:'Collection View',mobileAppWidget:true,defaultWidth:0,defaultHeight:0,section:'Containers and forms',themeEditorSection:null,tags:['group','container','mobile'],icon: listView,iconSmall: list,template:{instances:'{{self.data ? self.data.length : 0}}',data:tableDataTemplate,showSeparator:true,itemTemplate,items:{},selectedEntry:{}},hidden:()=>true}];/* harmony default export */ const CollectionView_presets = (presets);
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/CollectionView/template.ts
/* harmony default export */ const template = ({data:'data',instances:'number',showSeparator:'boolean',itemTemplate:'object',items:'object',selectedEntry:'object'});
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/CollectionView/widgetRuntimeOptions.ts
const itemTemplateSelectors=Object.keys(itemTemplate).map(key=>`itemTemplate.${key}`);/* harmony default export */ const widgetRuntimeOptions = ((0,registry.registerMobile)({typeKey:'RNCollectionViewWidget',name:'CollectionView',template: template,events:['press','buttonPress'],propertyAnnotations:{data:{updatesSync:['instances']},instances:{updatesSync:[...itemTemplateSelectors],computeValueOverride:({model})=>{var _ref;const data=(_ref=model.data)!==null&&_ref!==void 0?_ref:[];return data.length;}}}}));
...
// EXTERNAL MODULE: ../node_modules/.pnpm/react-native-web@0.19.10_encoding@0.1.13_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/react-native-web/dist/exports/FlatList/index.js + 2 modules
var FlatList = __webpack_require__(265870);
...
var Switch = __webpack_require__(636773);
...
var Checkbox = __webpack_require__(508615);
// EXTERNAL MODULE: ./src/toolbox/Icon/Icon.tsx + 3683 modules
var Icon = __webpack_require__(312220);
...
//# sourceMappingURL=1870.a7bf5f8f.chunk.js.map