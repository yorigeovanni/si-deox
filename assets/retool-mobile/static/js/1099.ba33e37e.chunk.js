(self["webpackChunkwebpack_mobile"] = self["webpackChunkwebpack_mobile"] || []).push([[1099],{
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/Fab/options.ts
const options={styles:{prefix:'fab',props:{text:{defaultValue:'#EFEFF0'},background:{defaultValue:'primary'}}}};/* harmony default export */ const Fab_options = (options);
// EXTERNAL MODULE: ../packages/runtimeShared/plugins/registry.ts + 28 modules
var registry = __webpack_require__(730223);
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/Fab/template.ts
/* harmony default export */ const template = ({icon:'icon',text:'string',disabled:'boolean',loading:'boolean'});
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/Fab/widgetRuntimeOptions.ts
/* harmony default export */ const widgetRuntimeOptions = ((0,registry.registerMobile)({typeKey:'RNFabWidget',name:'Fab',template: template,events:['click']}));
...
// EXTERNAL MODULE: ../node_modules/.pnpm/@react-native-aria+overlays@0.3.11_react-dom@18.3.1_react@18.3.1__react-native@0.74.3_@babel+_kkkn4ed3a2o67k64mxh2gbka7q/node_modules/@react-native-aria/overlays/lib/module/index.web.js + 37 modules
var index_web = __webpack_require__(484749);
// EXTERNAL MODULE: ../node_modules/.pnpm/@react-navigation+bottom-tabs@6.0.9_rinri732owyodmrqp3dvuvri5u/node_modules/@react-navigation/bottom-tabs/lib/module/utils/BottomTabBarHeightContext.js
var BottomTabBarHeightContext = __webpack_require__(271649);
;// CONCATENATED MODULE: ../node_modules/.pnpm/@react-navigation+bottom-tabs@6.0.9_rinri732owyodmrqp3dvuvri5u/node_modules/@react-navigation/bottom-tabs/lib/module/utils/useBottomTabBarHeight.js
function useFloatingBottomTabBarHeight(){const height=react.useContext(BottomTabBarHeightContext["default"]);if(height===undefined){throw new Error("Couldn't find the bottom tab bar height. Are you inside a screen in Bottom Tab Navigator?");}return height;}
...
var lib_module = __webpack_require__(315420);
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/Fab/styleConfig.ts
const styleConfig_styleConfig=(0,styleConfig["default"])('fab',{text:{type:'contrastText',context:'background'},background:{type:'defaultColor',defaultValue:'primary'}});/* harmony default export */ const Fab_styleConfig = (styleConfig_styleConfig);
...
// EXTERNAL MODULE: ./src/components/MobileViewerContext.ts
var MobileViewerContext = __webpack_require__(94001);
// EXTERNAL MODULE: ../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(453175);
;// CONCATENATED MODULE: ./src/components/plugins/widgets/Fab/Fab.tsx
const styles=StyleSheet["default"].create({overlay:{overflow:'hidden'},container:{position:'absolute',right:16},relativeContainer:{position:'relative'}});const PortalOnCurrentScreen=({children})=>{const isFocused=(0,lib_module.useIsFocused)();if(isFocused){return (0,jsx_runtime.jsx)(index_web.OverlayContainer,{style:styles.overlay,children:children});}return children;};const BOTTOM_PADDING_WITHOUT_TAB_BAR=75;const BOTTOM_PADDING_WITH_TAB_BAR=16;const Fab_Fab=({id,text,icon,disabled,style,hidden,loading,onPress,apiRef,renderWrapper})=>{let tabBarHeight=0;const runtimeStyles=(0,react.useMemo)(()=>{var _style$toObject;return(_style$toObject=style===null||style===void 0?void 0:style.toObject())!==null&&_style$toObject!==void 0?_style$toObject:{};},[style]);const{hydratedProps}=(0,useStyles["default"])({config:Fab_styleConfig,styles:{background:runtimeStyles.background,text:runtimeStyles.text}});const{baseBackgroundColor,baseTextColor}=(()=>{const{background,text}=hydratedProps!==null&&hydratedProps!==void 0?hydratedProps:{};return{baseBackgroundColor:background,baseTextColor:text};})();const textStyle=(0,react.useMemo)(()=>disabled?(0,colorUtils.withDisabledWash)(baseTextColor):baseTextColor,[baseTextColor,disabled]);try{tabBarHeight=useFloatingBottomTabBarHeight();}catch{}const mobileViewerContext=(0,react.useContext)(MobileViewerContext["default"]);const label=(()=>{if(loading){return (0,jsx_runtime.jsx)(ActivityIndicator["default"],{size:18,color:textStyle});}return text||icon?(0,jsx_runtime.jsxs)(View["default"],{style:{flexDirection:'row',justifyContent:'center',alignItems:'center'},children:[!!icon&&(0,jsx_runtime.jsx)(View["default"],{children:(0,jsx_runtime.jsx)(Icon.Icon,{name:icon,size:18,color:textStyle})}),!!text&&!!icon&&(0,jsx_runtime.jsx)(Text["default"],{children:`  `}),!!text&&(0,jsx_runtime.jsx)(design_system_Text["default"],{size:"h4",color:textStyle,value:text})]}):null;})();return hidden?null:(0,jsx_runtime.jsx)(PortalOnCurrentScreen,{children:(0,jsx_runtime.jsx)(View["default"],{style:[styles.container,{bottom:!tabBarHeight?BOTTOM_PADDING_WITHOUT_TAB_BAR:tabBarHeight+BOTTOM_PADDING_WITH_TAB_BAR}],children:(0,jsx_runtime.jsx)(View["default"],{style:styles.relativeContainer,children:(0,jsx_runtime.jsx)(MobileViewerContext["default"].Provider,{value:mobileViewerContext,children:renderWrapper===null||renderWrapper===void 0?void 0:renderWrapper((0,jsx_runtime.jsx)(Box.Box,{position:"relative",children:(0,jsx_runtime.jsx)(Fab.Fab,{onPress:onPress,ref:apiRef,label:label,disabled:disabled,backgroundColor:baseBackgroundColor},id)}))})})})});};/* harmony default export */ const widgets_Fab_Fab = (Fab_Fab);
;// CONCATENATED MODULE: ./src/components/plugins/widgets/Fab/FabWidget.tsx
const _excluded=["onClick"];function ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function _objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}/* harmony default export */ const FabWidget = ((0,connectMobileWidget["default"])(widgetRuntimeOptions.typeKey,widgets_Fab_Fab,widgetRuntimeOptions,Fab_options,_ref=>{let{onClick}=_ref,props=(0,objectWithoutProperties["default"])(_ref,_excluded);return _objectSpread(_objectSpread({},props),{},{onPress:onClick});}));
...
//# sourceMappingURL=1099.ba33e37e.chunk.js.map