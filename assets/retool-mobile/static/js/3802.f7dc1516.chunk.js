(self["webpackChunkwebpack_mobile"] = self["webpackChunkwebpack_mobile"] || []).push([[3802],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ RadioGroupWidget)
});
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/RadioGroup/template.ts
function ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function _objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}/* harmony default export */ const template = (_objectSpread(_objectSpread({},commonTemplates.formFieldTemplate),{},{value:'primitive',values:'primitive[]',labels:'string[]',disabled:'boolean'}));
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/RadioGroup/widgetRuntimeOptions.ts
/* harmony default export */ const widgetRuntimeOptions = ((0,registry.registerMobile)({typeKey:'RNRadioGroupWidget',name:'RadioGroup',template: template,events:['change'],formFieldType:'mobile'}));
...
;// CONCATENATED MODULE: ./src/components/plugins/widgets/RadioGroup/RadioGroup.tsx
const RadioButton=({label,value,isSelected,onChange,color,disabled})=>{return (0,jsx_runtime.jsxs)(Pressable["default"],{style:{paddingVertical:4,flexDirection:'row',alignItems:'center',flexWrap:'wrap'},disabled:disabled,onPress:()=>onChange===null||onChange===void 0?void 0:onChange(value),children:[(0,jsx_runtime.jsx)(View["default"],{style:{borderWidth:1,width:24,height:24,borderRadius:12,alignItems:'center',justifyContent:'center',borderColor:color,opacity:disabled?0.6:1,marginRight:12},children:isSelected?(0,jsx_runtime.jsx)(View["default"],{style:{width:16,height:16,borderRadius:8,opacity:disabled?0.6:1,backgroundColor:color}}):null}),label?(0,jsx_runtime.jsx)(Text["default"],{value:label,color:disabled?colors.disabledInputText:colors.gray900,size:"medium",ellipsizeMode:"tail",numberOfLines:1}):null]});};const RadioGroup=({labels,value,values,onChange,disabled})=>{const theme=(0,react.useContext)(utilities_theme["default"]);const primary=theme.primary;const radioButtons=(0,react.useMemo)(()=>values.map((v,idx)=>(0,jsx_runtime.jsx)(RadioButton,{label:labels[idx],isSelected:v===value,value:v,onChange:onChange,disabled:disabled,color:primary},`${v}`)),[labels,onChange,value,values,disabled,primary]);return (0,jsx_runtime.jsx)(View["default"],{style:{flexDirection:'column'},children:radioButtons});};/* harmony default export */ const RadioGroup_RadioGroup = (RadioGroup);
;// CONCATENATED MODULE: ./src/components/plugins/widgets/RadioGroup/RadioGroupWidget.tsx
const _excluded=["onChange","updateModel"];function RadioGroupWidget_ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function RadioGroupWidget_objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?RadioGroupWidget_ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):RadioGroupWidget_ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}/* harmony default export */ const RadioGroupWidget = ((0,connectMobileWidget["default"])(widgetRuntimeOptions.typeKey,RadioGroup_RadioGroup,widgetRuntimeOptions,{},_ref=>{let{onChange,updateModel}=_ref,rest=(0,objectWithoutProperties["default"])(_ref,_excluded);return RadioGroupWidget_objectSpread(RadioGroupWidget_objectSpread({},rest),{},{onChange:value=>{updateModel({value});onChange===null||onChange===void 0?void 0:onChange();}});}));
...
//# sourceMappingURL=3802.f7dc1516.chunk.js.map