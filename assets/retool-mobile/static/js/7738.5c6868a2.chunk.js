(self["webpackChunkwebpack_mobile"] = self["webpackChunkwebpack_mobile"] || []).push([[7738],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ ZebraReaderWidget)
});
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/ZebraReader/options.ts
const options={styles:{prefix:'zebrareader',props:{text:{defaultValue:'#EFEFF0'},background:{defaultValue:'primary'}}}};/* harmony default export */ const ZebraReader_options = (options);
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/ZebraReader/template.ts
function ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function _objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}/* harmony default export */ const template = (_objectSpread({data:'unknown?',buttonText:'string',buttonSize:['small','large'],iconAfter:'icon',iconBefore:'icon',disabled:'boolean',global:'boolean'},layout.widthTemplate));
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/ZebraReader/widgetRuntimeOptions.ts
/* harmony default export */ const widgetRuntimeOptions = ((0,registry.registerMobile)({typeKey:'RNZebraReaderWidget',name:'Zebra DataWedge Reader',template: template,events:['capture']}));
...
var useStableRef = __webpack_require__(972554);
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/ZebraReader/styleConfig.ts
const styleConfig_styleConfig=(0,styleConfig["default"])('zebrareader',{text:{type:'color',color:'#EFEFF0'},background:{type:'defaultColor',defaultValue:'primary'}});/* harmony default export */ const ZebraReader_styleConfig = (styleConfig_styleConfig);
...
var useIsCurrentAppScreenActive = __webpack_require__(847731);
...
// EXTERNAL MODULE: ./src/utilities/zebraDatawedge.ts
var zebraDatawedge = __webpack_require__(991164);
...
;// CONCATENATED MODULE: ./src/components/plugins/widgets/ZebraReader/ZebraReader.tsx
const useMemoryRef=value=>{const memory=(0,react.useRef)(value);(0,react.useEffect)(()=>{memory.current=value;},[value]);return memory;};const ZebraReader=props=>{var _theme$borderRadius;const{style,disabled,iconAfter,iconBefore,buttonText,buttonSize,fetching=false,onCapture,global}=props;const isCurrentAppScreenActive=(0,useIsCurrentAppScreenActive["default"])();const listeningForEvents=useMemoryRef(global||isCurrentAppScreenActive);const stableOnCapture=(0,useStableRef["default"])(onCapture);(0,react.useEffect)(()=>{zebraDatawedge.maybeStart();const unsubscribe=zebraDatawedge.onReceive(intent=>{if(listeningForEvents.current){if(zebraDatawedge.getIntentType(intent)==='passive'){var _stableOnCapture$curr;(_stableOnCapture$curr=stableOnCapture.current)===null||_stableOnCapture$curr===void 0?void 0:_stableOnCapture$curr.call(stableOnCapture,intent);}}});return unsubscribe;},[stableOnCapture,listeningForEvents]);const theme=(0,react.useContext)(utilities_theme["default"]);const runtimeStyles=(0,react.useMemo)(()=>{var _style$toObject;return(_style$toObject=style===null||style===void 0?void 0:style.toObject())!==null&&_style$toObject!==void 0?_style$toObject:{};},[style]);const{hydratedProps}=(0,useStyles["default"])({config:ZebraReader_styleConfig,styles:{text:runtimeStyles.text,background:runtimeStyles.background}});const{backgroundColor,textColor}=(()=>{const{text,background}=hydratedProps!==null&&hydratedProps!==void 0?hydratedProps:{};return{backgroundColor:background,textColor:text};})();const iconColor=(0,useIconColor.useIconColor)(textColor,disabled);const borderRadius=(_theme$borderRadius=theme.borderRadius)!==null&&_theme$borderRadius!==void 0?_theme$borderRadius:6;const handleSendRequest=(0,react.useCallback)(()=>{zebraDatawedge.sendCommand('com.symbol.datawedge.api.SOFT_SCAN_TRIGGER','TOGGLE_SCANNING');},[]);const handlePress=(0,react.useCallback)(()=>{handleSendRequest();},[handleSendRequest]);return (0,jsx_runtime.jsx)(Button["default"],{textColor:textColor,disabled:disabled,leftElement:iconBefore?(0,jsx_runtime.jsx)(Icon.Icon,{name:iconBefore,color:iconColor}):null,rightElement:iconAfter?(0,jsx_runtime.jsx)(Icon.Icon,{name:iconAfter,color:iconColor}):null,backgroundColor:backgroundColor,size:buttonSize,onPress:handlePress,title:buttonText,loading:fetching,borderRadius:borderRadius});};/* harmony default export */ const ZebraReader_ZebraReader = (ZebraReader);
;// CONCATENATED MODULE: ./src/components/plugins/widgets/ZebraReader/ZebraReaderWidget.tsx
const _excluded=["updateModel","onCapture"];function ZebraReaderWidget_ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function ZebraReaderWidget_objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?ZebraReaderWidget_ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):ZebraReaderWidget_ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}/* harmony default export */ const ZebraReaderWidget = ((0,connectMobileWidget["default"])(widgetRuntimeOptions.typeKey,ZebraReader_ZebraReader,widgetRuntimeOptions,ZebraReader_options,_ref=>{let{updateModel,onCapture}=_ref,rest=(0,objectWithoutProperties["default"])(_ref,_excluded);return ZebraReaderWidget_objectSpread(ZebraReaderWidget_objectSpread({},rest),{},{onCapture(intent){updateModel({data:intent});onCapture===null||onCapture===void 0?void 0:onCapture();}});}));
...
/* harmony export */ });
/* harmony import */ var _retool_builder_retool_development_mobile_node_modules_react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(985707);
/* harmony import */ var _react_navigation_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(315420);
/* harmony import */ var _useParentNavigationState__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(471242);
...
//# sourceMappingURL=7738.5c6868a2.chunk.js.map