(self["webpackChunkwebpack_mobile"] = self["webpackChunkwebpack_mobile"] || []).push([[9520],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ IconWidget)
});

;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/Icon/options.ts
const options={styles:{prefix:'icon',props:{color:{defaultValue:'textAuto',contrast:'#EFEFF0'}}}};/* harmony default export */ const Icon_options = (options);
// EXTERNAL MODULE: ../packages/runtimeShared/plugins/registry.ts + 28 modules
var registry = __webpack_require__(730223);
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/Icon/template.ts
/* harmony default export */ const template = ({type:['library','uri','svg'],icon:'icon',svg:'string',uri:'string',width:['fixed','full'],widthPx:'number?',hidden:'boolean'});
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/Icon/widgetRuntimeOptions.ts
/* harmony default export */ const widgetRuntimeOptions = ((0,registry.registerMobile)({typeKey:'RNIconWidget',name:'Icon',template: template,events:['click'],propertyAnnotations:{width:{hidden:true}}}));
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/Icon/styleConfig.ts
const styleConfig_styleConfig=(0,styleConfig["default"])('icon',{background:{type:'color',color:'#EFEFF0'},color:{type:'contrastText',context:'background'}});/* harmony default export */ const Icon_styleConfig = (styleConfig_styleConfig);
...
// EXTERNAL MODULE: ./src/toolbox/Svg/CustomSvg.tsx
var CustomSvg = __webpack_require__(299421);
...
;// CONCATENATED MODULE: ./src/components/plugins/widgets/Icon/PressableHack.native-web.tsx
const buttonReset={padding:0,border:'none',background:'none',display:'flex'};const PressableHack=props=>{const{onPress,children}=props;const editorCapturesClicks=(0,react.useContext)(LayoutWrapper.EditorCapturesClicksContext);return (0,jsx_runtime.jsx)("button",{type:"button",style:buttonReset,onClick:editorCapturesClicks?undefined:onPress,children:children});};/* harmony default export */ const PressableHack_native_web = (PressableHack);
;// CONCATENATED MODULE: ./src/components/plugins/widgets/Icon/Icon.tsx
const styles=StyleSheet["default"].create({fixedContainer:{display:'flex',flexDirection:'row'}});const Icon_Icon=props=>{const{icon,widthPx,onClick,style,uri='',svg='',type='library',renderWrapper}=props;const handleClick=(0,react.useCallback)(()=>{onClick===null||onClick===void 0?void 0:onClick();},[onClick]);const runtimeStyles=(0,react.useMemo)(()=>{var _style$toObject;return(_style$toObject=style===null||style===void 0?void 0:style.toObject())!==null&&_style$toObject!==void 0?_style$toObject:{};},[style]);const{hydratedProps}=(0,useStyles["default"])({config:Icon_styleConfig,styles:runtimeStyles});const color=hydratedProps===null||hydratedProps===void 0?void 0:hydratedProps.color;const size=Math.max(widthPx||18,0);const component=(0,react.useMemo)(()=>{const imageStyle={width:size,height:size};return type==='svg'?(0,jsx_runtime.jsx)(CustomSvg.CustomSvg,{xml:svg,height:size,width:size,color:color}):type==='uri'?(0,jsx_runtime.jsx)(Image["default"],{testID:"Image",source:{uri},width:size,height:size,style:imageStyle}):(0,jsx_runtime.jsx)(Icon.Icon,{name:icon||'line/interface-alert-warning-circle',color:color,size:size});},[type,svg,size,color,uri,icon]);return (0,jsx_runtime.jsx)(View["default"],{style:styles.fixedContainer,children:renderWrapper===null||renderWrapper===void 0?void 0:renderWrapper((0,jsx_runtime.jsx)(PressableHack_native_web,{onPress:handleClick,children:component}))});};/* harmony default export */ const widgets_Icon_Icon = (Icon_Icon);
;// CONCATENATED MODULE: ./src/components/plugins/widgets/Icon/IconWidget.tsx
/* harmony default export */ const IconWidget = ((0,connectMobileWidget["default"])(widgetRuntimeOptions.typeKey,widgets_Icon_Icon,widgetRuntimeOptions,Icon_options,props=>props));
...
//# sourceMappingURL=9520.25b0a78e.chunk.js.map