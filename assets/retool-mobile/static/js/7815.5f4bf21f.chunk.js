(self["webpackChunkwebpack_mobile"] = self["webpackChunkwebpack_mobile"] || []).push([[7815],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ DividerWidget)
});

;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/Divider/options.ts
const options={styles:{prefix:'divider',props:{color:{defaultValue:'#DEDEDE'}}}};/* harmony default export */ const Divider_options = (options);
// EXTERNAL MODULE: ../packages/runtimeShared/plugins/registry.ts + 28 modules
var registry = __webpack_require__(730223);
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/Divider/template.ts
/* harmony default export */ const template = ({spacing:'number'});
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/Divider/widgetRuntimeOptions.ts
/* harmony default export */ const widgetRuntimeOptions = ((0,registry.registerMobile)({typeKey:'RNDividerWidget',name:'Divider',template: template,events:[]}));
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/Divider/styleConfig.ts
const styleConfig_styleConfig=(0,styleConfig["default"])('divider',{color:{type:'color',color:'#DEDEDE'}});/* harmony default export */ const Divider_styleConfig = (styleConfig_styleConfig);
...
;// CONCATENATED MODULE: ./src/components/plugins/widgets/Divider/Divider.tsx
const _excluded=["spacing","id","style"];const styles=StyleSheet["default"].create({columnDivider:{borderBottomColor:colors.nearGrey,borderBottomWidth:1,width:'100%',height:1},rowDivider:{borderRightColor:colors.nearGrey,borderRightWidth:1,maxWidth:1,height:'100%'}});const Divider=_ref=>{let{spacing,id,style}=_ref,props=(0,objectWithoutProperties["default"])(_ref,_excluded);const containerId=props.rgProps.containerId;const appTemplate=(0,es.useSelector)(appTemplateSelectors.appTemplateSelector);const containerPlugin=containerId?appTemplate.getPluginNotTypesafe(containerId):undefined;const containerLayout=containerPlugin?containerPlugin.getIn(['template','layout']):'column';const runtimeStyles=(0,react.useMemo)(()=>{var _style$toObject;return(_style$toObject=style===null||style===void 0?void 0:style.toObject())!==null&&_style$toObject!==void 0?_style$toObject:{};},[style]);const{hydratedProps}=(0,useStyles["default"])({config:Divider_styleConfig,styles:runtimeStyles});const color=hydratedProps===null||hydratedProps===void 0?void 0:hydratedProps.color;return (0,jsx_runtime.jsx)(View["default"],{style:containerLayout==='row'?[styles.rowDivider,{marginHorizontal:spacing,alignSelf:'center',borderRightColor:color}]:[styles.columnDivider,{marginVertical:spacing,alignSelf:'center',borderBottomColor:color}],children:(0,jsx_runtime.jsx)(Text["default"],{children:` `})});};/* harmony default export */ const Divider_Divider = (Divider);
;// CONCATENATED MODULE: ./src/components/plugins/widgets/Divider/DividerWidget.tsx
/* harmony default export */ const DividerWidget = ((0,connectMobileWidget["default"])(widgetRuntimeOptions.typeKey,Divider_Divider,widgetRuntimeOptions,Divider_options,props=>props));
...
//# sourceMappingURL=7815.5f4bf21f.chunk.js.map