(self["webpackChunkwebpack_mobile"] = self["webpackChunkwebpack_mobile"] || []).push([[3981],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ NFCReaderWidget)
});
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/NFCReader/options.ts
const options={styles:{prefix:'nfc-reader',props:{label:{defaultValue:'textAuto',contrast:'background'},background:{defaultValue:'primary'}}}};/* harmony default export */ const NFCReader_options = (options);
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/NFCReader/template.ts
function ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function _objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}/* harmony default export */ const template = (_objectSpread({rawData:'unknown?',data:'array',buttonText:'string',buttonSize:['small','large'],iconAfter:'icon',iconBefore:'icon',disabled:'boolean'},layout.widthTemplate));
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/NFCReader/widgetRuntimeOptions.ts
/* harmony default export */ const widgetRuntimeOptions = ((0,registry.registerMobile)({typeKey:'RNNFCReaderWidget',name:'NFC Reader',template: template,events:['capture'],refMethods:['read','reset'],api:({updateModel,ref})=>({read:{metadata:{label:'Read NFC tag',description:'Open the NFC reader overlay'},method:async()=>{if(ref){const reader=ref;reader===null||reader===void 0?void 0:reader.read();}}},reset:{metadata:{label:'Reset data',description:'Reset the data from the NFC reader'},method:async()=>updateModel({data:[],rawData:null})}})}));
// EXTERNAL MODULE: ./src/utilities/nfc/parseNFC.ts
var parseNFC = __webpack_require__(299865);
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/NFCReader/styleConfig.ts
const styleConfig_styleConfig=(0,styleConfig["default"])('nfc-reader',{background:{type:'defaultColor',defaultValue:'primary'},label:{type:'contrastText',context:'background'}});/* harmony default export */ const NFCReader_styleConfig = (styleConfig_styleConfig);
...
// EXTERNAL MODULE: ./src/utilities/nfc/nfcRef.ts
var nfcRef = __webpack_require__(540783);
...
;// CONCATENATED MODULE: ./src/components/plugins/widgets/NFCReader/NFCReader.tsx
const NFCReader=(0,react.forwardRef)(function NFCReader(props,ref){var _theme$borderRadius;const{onCapture,style,disabled,iconAfter,iconBefore,buttonText,buttonSize,fetching=false}=props;const handleReadRequest=(0,react.useCallback)(async()=>{if(nfcRef.nfcRef.current){const data=await nfcRef.nfcRef.current.read();if(data){onCapture===null||onCapture===void 0?void 0:onCapture(data.rawData);}}},[onCapture]);(0,react.useImperativeHandle)(ref,()=>({read:()=>{handleReadRequest();}}));const theme=(0,react.useContext)(utilities_theme["default"]);const runtimeStyles=(0,react.useMemo)(()=>{var _style$toObject;return(_style$toObject=style===null||style===void 0?void 0:style.toObject())!==null&&_style$toObject!==void 0?_style$toObject:{};},[style]);const{hydratedProps}=(0,useStyles["default"])({config:NFCReader_styleConfig,styles:{label:runtimeStyles.label,background:runtimeStyles.background}});const{backgroundColor,textColor}=(()=>{const{label,background}=hydratedProps!==null&&hydratedProps!==void 0?hydratedProps:{};return{backgroundColor:background,textColor:label};})();const iconColor=(0,useIconColor.useIconColor)(textColor,disabled);const borderRadius=(_theme$borderRadius=theme.borderRadius)!==null&&_theme$borderRadius!==void 0?_theme$borderRadius:6;return (0,jsx_runtime.jsx)(Button["default"],{textColor:textColor,disabled:disabled,leftElement:iconBefore?(0,jsx_runtime.jsx)(Icon.Icon,{name:iconBefore,color:iconColor}):null,rightElement:iconAfter?(0,jsx_runtime.jsx)(Icon.Icon,{name:iconAfter,color:iconColor}):null,backgroundColor:backgroundColor,size:buttonSize,onPress:handleReadRequest,title:buttonText,loading:fetching,borderRadius:borderRadius});});/* harmony default export */ const NFCReader_NFCReader = (NFCReader);
;// CONCATENATED MODULE: ./src/components/plugins/widgets/NFCReader/NFCReaderWidget.tsx
const _excluded=["updateModel","onCapture","apiRef"];function NFCReaderWidget_ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function NFCReaderWidget_objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?NFCReaderWidget_ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):NFCReaderWidget_ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}/* harmony default export */ const NFCReaderWidget = ((0,connectMobileWidget["default"])(widgetRuntimeOptions.typeKey,NFCReader_NFCReader,widgetRuntimeOptions,NFCReader_options,_ref=>{let{updateModel,onCapture,apiRef}=_ref,rest=(0,objectWithoutProperties["default"])(_ref,_excluded);return NFCReaderWidget_objectSpread(NFCReaderWidget_objectSpread({},rest),{},{ref:apiRef,onCapture(tag){const parsedData=(0,parseNFC["default"])(tag);updateModel({rawData:tag,data:parsedData});onCapture===null||onCapture===void 0?void 0:onCapture();}});}));
...
//# sourceMappingURL=3981.bbdcfd40.chunk.js.map