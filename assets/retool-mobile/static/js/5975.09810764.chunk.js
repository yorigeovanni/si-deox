(self["webpackChunkwebpack_mobile"] = self["webpackChunkwebpack_mobile"] || []).push([[5975],{
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/WebView/options.ts
const options={styles:{prefix:'button',props:{label:{defaultValue:'textAuto',contrast:'background'},background:{defaultValue:'primary'}}}};/* harmony default export */ const WebView_options = (options);
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/WebView/template.ts
function ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function _objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}/* harmony default export */ const template = (_objectSpread({url:'string',buttonText:'string',buttonSize:'string',iconAfter:'icon',iconBefore:'icon',disabled:'boolean'},layout.widthTemplate));
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/WebView/widgetRuntimeOptions.ts
/* harmony default export */ const widgetRuntimeOptions = ((0,registry.registerMobile)({typeKey:'RNWebViewWidget',name:'WebView',template: template,events:['open']}));
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/WebView/styleConfig.ts
const styleConfig_styleConfig=(0,styleConfig["default"])('button',{background:{type:'defaultColor',defaultValue:'primary'},label:{type:'contrastText',context:'background'}});/* harmony default export */ const WebView_styleConfig = (styleConfig_styleConfig);
...
// EXTERNAL MODULE: ../frontend/src/store/appModel/jsApiUtils/openUrl/openUrl.native-web.ts + 1 modules
var openUrl_native_web = __webpack_require__(338303);
...
;// CONCATENATED MODULE: ./src/components/plugins/widgets/WebView/WebView.tsx
const RNWebView=({style,disabled,buttonText,buttonSize,iconBefore,iconAfter,onOpen,url,fetching=false})=>{var _theme$borderRadius;const theme=(0,react.useContext)(utilities_theme["default"]);const runtimeStyles=(0,react.useMemo)(()=>{var _style$toObject;return(_style$toObject=style===null||style===void 0?void 0:style.toObject())!==null&&_style$toObject!==void 0?_style$toObject:{};},[style]);const{hydratedProps}=(0,useStyles["default"])({config:WebView_styleConfig,styles:{label:runtimeStyles.label,background:runtimeStyles.background}});const{backgroundColor,textColor}=(()=>{const{label,background}=hydratedProps!==null&&hydratedProps!==void 0?hydratedProps:{};return{backgroundColor:background,textColor:label};})();const iconColor=(0,useIconColor.useIconColor)(textColor,disabled);const borderRadius=(_theme$borderRadius=theme.borderRadius)!==null&&_theme$borderRadius!==void 0?_theme$borderRadius:6;const openWebView=async()=>{onOpen===null||onOpen===void 0?void 0:onOpen();openUrl_native_web["default"].method(url);};return (0,jsx_runtime.jsx)(Button["default"],{backgroundColor:backgroundColor,textColor:textColor,onPress:openWebView,disabled:disabled,leftElement:iconBefore?(0,jsx_runtime.jsx)(Icon.Icon,{name:iconBefore,color:iconColor}):null,rightElement:iconAfter?(0,jsx_runtime.jsx)(Icon.Icon,{name:iconAfter,color:iconColor}):null,size:buttonSize,title:buttonText,loading:fetching,borderRadius:borderRadius});};/* harmony default export */ const WebView = (RNWebView);
;// CONCATENATED MODULE: ./src/components/plugins/widgets/WebView/WebViewWidget.tsx
const _excluded=["bodyGrid","buttonSize"];function WebViewWidget_ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function WebViewWidget_objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?WebViewWidget_ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):WebViewWidget_ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}/* harmony default export */ const WebViewWidget = ((0,connectMobileWidget["default"])(widgetRuntimeOptions.typeKey,WebView,widgetRuntimeOptions,WebView_options,_ref=>{let{bodyGrid,buttonSize}=_ref,rest=(0,objectWithoutProperties["default"])(_ref,_excluded);return WebViewWidget_objectSpread({buttonSize},rest);}));
...
//# sourceMappingURL=5975.09810764.chunk.js.map