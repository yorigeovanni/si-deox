(self["webpackChunkwebpack_mobile"] = self["webpackChunkwebpack_mobile"] || []).push([[6517],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ CheckboxGroupWidget)
});
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/Checkbox/template.ts
function ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function _objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}/* harmony default export */ const template = (_objectSpread(_objectSpread({},commonTemplates.formFieldTemplate),{},{label:'string',labelCaption:'string',labels:'string[]',value:'string[]',values:'string[]',disabled:'boolean',type:['checkbox','switch']}));
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/Checkbox/widgetRuntimeOptions.ts
/* harmony default export */ const widgetRuntimeOptions = ((0,registry.registerMobile)({typeKey:'RNCheckboxWidget',name:'Checkbox',events:['change'],template: template,validation:true,formFieldType:'mobile'}));
...
// EXTERNAL MODULE: ../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/zipWith.js
var zipWith = __webpack_require__(264779);
...
// EXTERNAL MODULE: ./src/components/plugins/widgets/Switch/Switch.tsx
var Switch = __webpack_require__(712301);
// EXTERNAL MODULE: ../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(102658);
;// CONCATENATED MODULE: ./src/components/plugins/widgets/Checkbox/CheckboxGroup.tsx
const CheckboxGroup=({id,value=[],values=[],labels=[],label,fetching=false,disabled=false,required=false,onChange,type})=>{const items=(0,react.useMemo)(()=>zipWith_default()(values,labels,(value,label)=>{return{label:label?label:value,value};}),[values,labels]);const onSwitchChange=(0,react.useCallback)(item=>{if(value.includes(item.value)){const newValues=value.filter(val=>val!==item.value);onChange===null||onChange===void 0?void 0:onChange(newValues);}else{const newValues=[...value,item.value];onChange===null||onChange===void 0?void 0:onChange(newValues);}},[value,onChange]);const contents=(0,react.useMemo)(()=>items.map((item,itemIndex)=>(0,jsx_runtime.jsx)(TouchableOpacity["default"],{onPress:()=>onSwitchChange(item),children:(0,jsx_runtime.jsxs)(Box.Box,{display:"flex",direction:"row",gap:8,alignItems:"center",children:[(0,jsx_runtime.jsx)(Switch["default"],{type:type,value:value.includes(item.value),disabled:disabled||fetching,onChange:()=>onSwitchChange(item)}),(0,jsx_runtime.jsx)(Box.Box,{flex:1,display:"flex",direction:"column",children:(0,jsx_runtime.jsx)(Text["default"],{value:item.label,color:disabled?colors.disabledInputText:colors.gray900,size:"medium",ellipsizeMode:"tail"})})]})},itemIndex)),[items,type,value,disabled,fetching,onSwitchChange]);return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[!!label&&(0,jsx_runtime.jsx)(Label["default"],{title:label,loading:fetching,disabled:disabled,required:required}),(0,jsx_runtime.jsx)(Box.Box,{testId:id,display:"flex",direction:"column",children:contents})]});};/* harmony default export */ const Checkbox_CheckboxGroup = (CheckboxGroup);
;// CONCATENATED MODULE: ./src/components/plugins/widgets/Checkbox/CheckboxGroupWidget.tsx
const _excluded=["onChange","updateModel"];function CheckboxGroupWidget_ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function CheckboxGroupWidget_objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?CheckboxGroupWidget_ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):CheckboxGroupWidget_ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}/* harmony default export */ const CheckboxGroupWidget = ((0,connectMobileWidget["default"])(widgetRuntimeOptions.typeKey,Checkbox_CheckboxGroup,widgetRuntimeOptions,{},_ref=>{let{onChange,updateModel}=_ref,rest=(0,objectWithoutProperties["default"])(_ref,_excluded);return CheckboxGroupWidget_objectSpread(CheckboxGroupWidget_objectSpread({},rest),{},{onChange:value=>{updateModel({value});onChange===null||onChange===void 0?void 0:onChange();}});}));
...
/* harmony export */ });
/* harmony import */ var _retool_builder_retool_development_mobile_node_modules_react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(818414);
/* harmony import */ var react_native_web_dist_exports_Pressable__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(355710);
/* harmony import */ var react_native_web_dist_exports_StyleSheet__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(584235);
/* harmony import */ var react_native_web_dist_exports_Switch__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(905100);
/* harmony import */ var react_native_web_dist_exports_View__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(716165);
/* harmony import */ var _toolbox_Checkbox__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(465200);
/* harmony import */ var _utilities_colors__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(151391);
/* harmony import */ var _utilities_theme__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(135758);
/* harmony import */ var _design_system_Text__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(442381);
/* harmony import */ var _retool_builder_retool_development_mobile_node_modules_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(102658);
const SwitchStyles=react_native_web_dist_exports_StyleSheet__WEBPACK_IMPORTED_MODULE_5__["default"].create({container:{display:'flex',justifyContent:'space-between',padding:4,flexWrap:'wrap',flexDirection:'row'}});const lowerOpacity=hexColor=>{const color=hexColor.replace('#','');const red=parseInt(color.substr(0,2),16);const green=parseInt(color.substr(2,2),16);const blue=parseInt(color.substr(4,2),16);const opacity=0.6;const rgbaColor=`rgba(${red}, ${green}, ${blue}, ${opacity})`;return rgbaColor;};const Switch=({value,label,caption,onChange,disabled,type})=>{const theme=(0,_retool_builder_retool_development_mobile_node_modules_react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_utilities_theme__WEBPACK_IMPORTED_MODULE_2__["default"]);const primary=theme.primary;const getColor=color=>{return!disabled?color:lowerOpacity(color);};return (0,_retool_builder_retool_development_mobile_node_modules_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(react_native_web_dist_exports_View__WEBPACK_IMPORTED_MODULE_6__["default"],{style:[SwitchStyles.container],children:[(0,_retool_builder_retool_development_mobile_node_modules_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(react_native_web_dist_exports_View__WEBPACK_IMPORTED_MODULE_6__["default"],{style:{minWidth:label||caption?'50%':'auto',flexDirection:'column'},children:[label?(0,_retool_builder_retool_development_mobile_node_modules_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_design_system_Text__WEBPACK_IMPORTED_MODULE_3__["default"],{value:label,color:getColor(_utilities_colors__WEBPACK_IMPORTED_MODULE_7__.gray900),weight:"bold",ellipsizeMode:"tail",numberOfLines:1}):null,caption?(0,_retool_builder_retool_development_mobile_node_modules_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_design_system_Text__WEBPACK_IMPORTED_MODULE_3__["default"],{value:caption,color:getColor(_utilities_colors__WEBPACK_IMPORTED_MODULE_7__.grey),ellipsizeMode:"tail",numberOfLines:2}):null]}),type==='switch'?(0,_retool_builder_retool_development_mobile_node_modules_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(react_native_web_dist_exports_Switch__WEBPACK_IMPORTED_MODULE_8__["default"],{style:[{alignSelf:'flex-start'}],activeThumbColor:'white',value:value,onValueChange:()=>{onChange===null||onChange===void 0?void 0:onChange(!value);},thumbColor:"white",trackColor:{true:getColor(theme.primary),false:getColor(_utilities_colors__WEBPACK_IMPORTED_MODULE_7__.nearGrey)},disabled:disabled}):(0,_retool_builder_retool_development_mobile_node_modules_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(react_native_web_dist_exports_Pressable__WEBPACK_IMPORTED_MODULE_9__["default"],{onPress:event=>event.stopPropagation(),style:{alignSelf:'flex-start'},children:(0,_retool_builder_retool_development_mobile_node_modules_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_toolbox_Checkbox__WEBPACK_IMPORTED_MODULE_1__.Checkbox,{value:value,disabled:disabled,onChange:isSelected=>onChange===null||onChange===void 0?void 0:onChange(isSelected),backgroundColor:primary})})]});};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Switch);
...
var arrayFilter = __webpack_require__(622074),
    arrayMap = __webpack_require__(68126),
    baseProperty = __webpack_require__(97517),
    baseTimes = __webpack_require__(451356),
    isArrayLikeObject = __webpack_require__(198201);
...
var apply = __webpack_require__(929791),
    arrayMap = __webpack_require__(68126),
    unzip = __webpack_require__(479628);
...
var baseRest = __webpack_require__(545436),
    unzipWith = __webpack_require__(968804);
...
//# sourceMappingURL=6517.e4b841b5.chunk.js.map