(self["webpackChunkwebpack_mobile"] = self["webpackChunkwebpack_mobile"] || []).push([[4659],{
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/Status/template.ts
/* harmony default export */ const template = ({iconPosition:['left','right'],value:'string',hidden:'boolean',data:'data',itemMode:['dynamic','static'],_ids:'List<string>',iconByIndex:'icon[]',labels:'string[]',colorByIndex:'color[]',values:'string[]'});
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/Status/widgetRuntimeOptions.ts
/* harmony default export */ const widgetRuntimeOptions = ((0,registry.registerMobile)({typeKey:'RNStatusWidget',name:'Status',template: template,disableAutoAPI:['setValue','clearValue'],nestedItems:{itemFields:['color','icon','label','value']},api:({updateModel,getModel,id})=>({setValue:{metadata:{label:'Set value',description:'Set the current value.',example:"`status1.setValue('completed')`",params:[{type:'codeInput',name:'value',props:{label:'Value',validator:'string'}}]},method:value=>{(0,typeguards.assertIsString)(value,'Value parameter is not a string.');const model=getModel();if((0,typeguards.isNullish)(model)){return;}const values=model.get('values');if((0,typeguards.isNullish)(values)||values.length===0){throw new Error(`No states for ${id} defined.`);}if(!values.includes(value)){throw new Error(`Value is not a valid state for ${id}.`);}updateModel({value});}}})}));
// EXTERNAL MODULE: ../node_modules/.pnpm/memoize-one@5.2.1/node_modules/memoize-one/dist/memoize-one.esm.js
var memoize_one_esm = __webpack_require__(340115);
// EXTERNAL MODULE: ../frontend/src/components/plugins/widgets/v2/components/Icon/getIcon.native-web.tsx
var getIcon_native_web = __webpack_require__(521179);
;// CONCATENATED MODULE: ../frontend/src/components/plugins/widgets/v2/formatOptionsArray.ts
function ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function _objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}const formatOptionsArrayInner=({appTargetByIndex=[],captionByIndex=[],colorByIndex=[],textColorByIndex=[],disabled=false,disabledByIndex=[],disabledValues=[],hiddenByIndex=[],iconByIndex=[],iconPositionByIndex=[],imageByIndex=[],itemTypeByIndex=[],keyByIndex=[],parentKeyByIndex=[],highlightByIndex=[],fallbackTextByIndex=[],includeHidden,labels=[],screenTargetByIndex=[],screenTargetIdByIndex=[],tooltipByIndex=[],values=[]})=>{if(!Array.isArray(values)){return[];}const disabledValueArray=!disabled&&Array.isArray(disabledValues)?disabledValues:[];const noValues=values.length===0;if(noValues&&labels.length>0){values=labels.map((_,i)=>i);}const seenValues=new Set();return values.flatMap((value,i)=>{if(!includeHidden&&hiddenByIndex[i])return[];const formattedValue=(0,typeguards.isPrimitive)(value)?value:String(value);if(seenValues.has(formattedValue)){return[];}seenValues.add(formattedValue);const disabled=disabledByIndex[i]||!!(disabledValueArray!==null&&disabledValueArray!==void 0&&disabledValueArray.includes(value));const content=iconByIndex[i]?(0,getIcon_native_web["default"])(iconByIndex[i]):undefined;const contentPosition=iconPositionByIndex[i];const label=String(labels[i]||(content&&contentPosition==='replace'||noValues?'':formattedValue));return[_objectSpread({appTarget:appTargetByIndex[i],disabled,caption:captionByIndex[i],tooltip:tooltipByIndex[i],color:colorByIndex[i],textColor:textColorByIndex[i],image:imageByIndex[i],imageFallback:fallbackTextByIndex[i],itemType:itemTypeByIndex[i],content,contentPosition:iconPositionByIndex[i],iconString:iconByIndex[i],key:keyByIndex[i]||label,parentKey:parentKeyByIndex[i],highlight:highlightByIndex[i],label,screenTarget:screenTargetByIndex[i],screenTargetId:screenTargetIdByIndex[i],value:formattedValue},includeHidden?{hidden:hiddenByIndex[i]}:{})];});};const equalityFunction=([newArgs],[lastArgs])=>{const newKeys=Object.keys(newArgs);const lastKeys=Object.keys(lastArgs);if(newKeys.length!==lastKeys.length){return false;}for(const key of newKeys){const newInput=newArgs[key];const oldInput=lastArgs[key];if(newInput!==oldInput){if(Array.isArray(newInput)&&Array.isArray(oldInput)){if(!newInput.length&&!oldInput.length){continue;}}return false;}}return true;};let memoizedCache={};const clearCacheForTesting=()=>{memoizedCache={};};const formatOptionsArray=(id,args={})=>{if(!(id in memoizedCache)){memoizedCache[id]=(0,memoize_one_esm["default"])(formatOptionsArrayInner,equalityFunction);}return memoizedCache[id](args);};/* harmony default export */ const v2_formatOptionsArray = (formatOptionsArray);
...
;// CONCATENATED MODULE: ./src/components/plugins/widgets/Status/Status.tsx
const Status=({value,options,iconPosition})=>{const option=options===null||options===void 0?void 0:options.find(opt=>opt.value===value);if((0,typeguards.isNullish)(option)){return null;}const{iconString:icon,color,label}=option;return (0,jsx_runtime.jsxs)(View["default"],{style:{flexDirection:'row',gap:8,padding:4,alignItems:'center'},children:[icon&&iconPosition==='left'?(0,jsx_runtime.jsx)(Icon.Icon,{name:icon,color:color}):null,(0,jsx_runtime.jsx)(Text["default"],{color:color,value:label}),icon&&iconPosition==='right'?(0,jsx_runtime.jsx)(Icon.Icon,{name:icon,color:color}):null]});};/* harmony default export */ const Status_Status = (Status);
;// CONCATENATED MODULE: ./src/components/plugins/widgets/Status/StatusWidget.tsx
const _excluded=["colorByIndex","iconByIndex","id","labels","values"];function StatusWidget_ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function StatusWidget_objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?StatusWidget_ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):StatusWidget_ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}/* harmony default export */ const StatusWidget = ((0,connectMobileWidget["default"])(widgetRuntimeOptions.typeKey,Status_Status,widgetRuntimeOptions,{},_ref=>{let{colorByIndex,iconByIndex,id,labels,values}=_ref,props=(0,objectWithoutProperties["default"])(_ref,_excluded);return StatusWidget_objectSpread({id,options:v2_formatOptionsArray(id,{colorByIndex,iconByIndex,labels,values})},props);}));
...
//# sourceMappingURL=4659.15f1fbd9.chunk.js.map