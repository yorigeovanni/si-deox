(self["webpackChunkwebpack_mobile"] = self["webpackChunkwebpack_mobile"] || []).push([[883],{
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _valueType_cast__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(332033);
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ TextInputWidget)
});
...
var validatePatterns = __webpack_require__(383645);
// EXTERNAL MODULE: ../packages/runtimeShared/plugins/widgets/v2/api/validation/validateStringLength.ts
var validateStringLength = __webpack_require__(496943);
;// CONCATENATED MODULE: ../frontend/src/components/plugins/widgets/v2/TextInput/validator.ts
const validator=model=>{const lengthError=(0,validateStringLength["default"])(model,{hideMessage:!!model.showCharacterCount});if(lengthError)return lengthError;return (0,validatePatterns["default"])(model);};/* harmony default export */ const TextInput_validator = (validator);
...
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/TextInput/template.ts
function ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function _objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}/* harmony default export */ const template = (_objectSpread(_objectSpread({},commonTemplates.formFieldTemplate),{},{autoCapitalize:['none','sentences','words','characters'],iconAfter:'icon',iconBefore:'icon',disabled:'boolean',maxLength:'number?',minLength:'number?',pattern:'string',patternType:['','email','url','regex'],showCharacterCount:'boolean',placeholder:'string',value:'string',label:'string',labelCaption:'string'}));
;// CONCATENATED MODULE: ../frontend/src/components/plugins/mobile/widgets/TextInput/widgetRuntimeOptions.ts
/* harmony default export */ const widgetRuntimeOptions = ((0,registry.registerMobile)({typeKey:'RNTextInputWidget',events:['submit','change','focus','blur','suffixIconPress'],name:'TextInput',formFieldType:'mobile',template: template,validation:{customFields:['patternType','pattern','minLength','maxLength','showCharacterCount'],customValidator:TextInput_validator}}));
...
var Input = __webpack_require__(645570);
...
var useFocusNextWidget = __webpack_require__(918752);
// EXTERNAL MODULE: ../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(102658);
;// CONCATENATED MODULE: ./src/components/plugins/widgets/TextInput/TextInput.tsx
const TextInput=({disabled,iconAfter,iconBefore,id,inputRef,label,onChange,onSubmit,onFocus,onBlur,onSuffixIconPress,placeholder,value,fetching=false,required,hideValidationMessage=false,validationMessage,instance})=>{const domId=instance&&instance>=0?`${id}--${instance}`:id;const focusNextWidget=(0,useFocusNextWidget.useFocusNextWidget)(domId);const errorMessage=hideValidationMessage?undefined:validationMessage;const iconColor=disabled?colors.disabledInputText:colors.gray900;return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[label?(0,jsx_runtime.jsx)(Label["default"],{title:label,loading:fetching,disabled:disabled,required:required}):null,(0,jsx_runtime.jsx)(Input["default"],{disabled:disabled,keyboardType:"default",onChange:onChange,placeholder:`${placeholder}`,inputRef:inputRef,returnKeyType:"next",value:value,onSubmit:()=>{onSubmit===null||onSubmit===void 0?void 0:onSubmit();focusNextWidget();},onFocus:onFocus,onBlur:onBlur,leftElement:iconBefore?(0,jsx_runtime.jsx)(Icon.Icon,{name:iconBefore,color:iconColor}):null,rightElement:iconAfter?(0,jsx_runtime.jsx)(Icon.Icon,{name:iconAfter,color:iconColor}):null,onRightElementPress:onSuffixIconPress,loading:fetching,error:!!errorMessage})]});};/* harmony default export */ const TextInput_TextInput = (TextInput);
;// CONCATENATED MODULE: ./src/components/plugins/widgets/TextInput/TextInputWidget.tsx
const _excluded=["apiRef","onChange","updateModel"];function TextInputWidget_ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function TextInputWidget_objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?TextInputWidget_ownKeys(Object(t),!0).forEach(function(r){(0,defineProperty["default"])(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):TextInputWidget_ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}/* harmony default export */ const TextInputWidget = ((0,connectMobileWidget["default"])(widgetRuntimeOptions.typeKey,TextInput_TextInput,widgetRuntimeOptions,{},_ref=>{let{apiRef,onChange,updateModel}=_ref,rest=(0,objectWithoutProperties["default"])(_ref,_excluded);return TextInputWidget_objectSpread(TextInputWidget_objectSpread({},rest),{},{inputRef:apiRef,onChange(value){updateModel({value});onChange();}});}));
...
//# sourceMappingURL=883.658378fc.chunk.js.map