...
export default function StakeholderScreen() {
  ...
  const { user, loading } = externalUser;
  const mainModules = [
    { name: "PAS BANDARA", icon: "cart", color: "#4CAF50", route: "./pas-bandara" },
    {
      name: "REKON DATA",
      icon: "cube",
      color: "#2196F3",
  ...
  useEffect(() => {
    if (!user) {
      setTimeout(() => {
        router.replace("/auth/login-external");
      }, 500);
    }
  }, [user, loading]);
          ...
          <View className="px-6 py-3 bg-[#991B1B]">
            <View className="flex-row justify-between items-center mb-8">
              ...
              <TouchableOpacity
                ...
                //onPress={() => router.push("/aplikasi-external/account")}
              >
                ...
                >
                  ...
                  <View className="bg-white/10 backdrop-blur-lg p-4 rounded-xl mr-4 w-56">
                    ...
                    <View className="flex-row items-center mt-2">
                      ...
                      <Text className="text-yellow-400 ml-1">
                        5 need attention
                      </Text>
                    </View>
                  </View>
                ...
                <View className="flex-row flex-wrap justify-start items-center">
                  {mainModules.map((module, index) => (
                    <TouchableOpacity
                      ...
                      onPress={() => module.route && router.push(module.route, { relativeToDirectory : true})}
                    >
                      <View
