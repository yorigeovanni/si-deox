...
export default function RootIndex() {
  ...
  const countrys = [{"value":"america","icon":"sort-amount-up","text":"United States","image":3,"checked":true},{"value":"vietname","icon":"sort-amount-down","text":"VietNam","image":2},{"value":"singapore","icon":"sort-amount-up","text":"Singapore","image":1},{"value":"indonesia","icon":"sort-amount-up","text":"Indonesia","image":4},{"value":"malaysia","icon":"sort-amount-up","text":"Malaysia","image":5},{"value":"philippines","icon":"sort-amount-up","text":"Philippines","image":6}];
    ...
    if (countrys?.length > 0) {
      return (
        <TouchableOpacity
          ...
          <Text body2>{countrySelected?.text || '0822-9191-4470'}</Text>
