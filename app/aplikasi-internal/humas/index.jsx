  ...
  const mainModules = [
    {
      ...
      icon: "people",
      color: "#EC4899",
      route: "/aplikasi-internal/humas/content-fasilitas",
    },
    {
      name: "LAYANAN",
      icon: "people",
      color: "#9D174D",
      route: "/aplikasi-internal/humas/content-layanan",
    },
    {
      name: "INFORMASI",
      icon: "people",
      color: "#DB2777",
      route: "/aplikasi-internal/humas/content-informasi",
    },
    {
      name: "KEGIATAN",
      icon: "people",
      color: "#BE123C",
      route: "/aplikasi-internal/humas/content-kegiatan",
    },
    {
      name: "PERATURAN",
      icon: "people",
      color: "#F43F5E",
      route: "/aplikasi-internal/humas/content-peraturan",
    },
    {
      name: "TARIF BATAS",
      icon: "checkbox",
      color: "#F472B6",
      route: "/aplikasi-internal/humas/content-tarif-batas",
    },
  ];
        ...
        <View className="px-2 -mt-12">
          <View className=" rounded-xl p-3 ">
            ...
            <View className="flex-row justify-between mb-6">
              <TouchableOpacity 
              onPress={() => router.push("/aplikasi-internal/humas/content-pengaduan")}
