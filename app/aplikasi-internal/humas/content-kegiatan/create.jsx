...
const x_studio_tags = [4]; // KEGIATAN
//===================================================================================
...
export default function CreatePostScreen() {
  ...
  const { mutate, isError, error, isPending } = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries(["humas-content-mobile", "home-content"]);
    },
  });
    ...
    <SafeAreaView className=" flex-1">
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Create Content Kegiatan</Text>
