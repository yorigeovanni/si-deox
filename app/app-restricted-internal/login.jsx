        ...
        >
            ...
            <View className={classNames(
                ...
                <View className="flex-col items-center justify-center space-y-0 mb-2 mt-6">
                    <Text className="text-white text-lg font-extrabold">DEO AIRPORT - INTERNAL LOGIN</Text>
                </View>
            </View>
    ...
    return (
        <Fragment>
            {timeLeft !== 0 ? (<Fragment>
                ...
                <Text className="text-lg font-semibold leading-5 mb-3 mt-8 text-center text-white">masukan kode OTP INTERNAL</Text>
