...
import { useInfiniteFindMany } from '@/services/external/@default-query';
...
export default () => {
    ...
    const {
        ...
        domain: [
            "&",
            ['x_studio_operator.x_studio_contact.id', '=', user.company?.id],
            ['x_studio_is_validated_from_upbu', '=', true],
            ['x_studio_is_validated_from_operator', '=', false],
            ['x_studio_is_cancel', '=', false]
        ],
        limit: DEFAULT_LIMIT,
    });
        ...
        return (
            <Fragment>
                <ExternalHeader
                    ...
                    subtitle='BLU UPBU KELAS I DEO - SORONG'
                />
        ...
        <Fragment>
            ...
            <View className='flex-row justify-between items-center px-8 py-4 bg-white border-b border-gray-200'>
                <View className='flex-row items-center space-x-4'>
                    <Text className=' text-lg font-bold'>REKON DATA ANGUD</Text>
                </View>
                <View className='flex-row items-center space-x-4'>
        ...
        <View className="flex-row items-center justify-between py-2 px-4 border-t border-gray-200 ">
            ...
            <View className='flex-row items-center space-x-2'>
                <TouchableOpacity className="border border-red-700 rounded-lg items-center mx-1 p-2">
                    <Text className="text-red-700 font-bold text-xs">UPDATE LANDING</Text>
                </TouchableOpacity>
            </View>
            ...
            <View className='flex-row items-center space-x-2'>
                ...
                <TouchableOpacity className=" bg-blue-600 rounded-lg items-center mx-1 p-2">
                    <Text className="text-white font-bold text-xs">SEND FINAL</Text>
                </TouchableOpacity>
