...
const basePath = "/app-restricted-internal";
...
export default function AppInternalMenu() {
    ...
    return (
        <Fragment>
            <Text style={{ fontWeight: "bold", fontSize: 16, marginBottom: 8, marginTop: 16, marginLeft: 16 }}>APLIKASI UTAMA</Text>
