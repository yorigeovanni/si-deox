          ...
          <View style={{ marginBottom: 20,  paddingHorizontal: 20 }}>
            ...
            >
              <View>
                ...
                <Text className={classNames(value ? '' : ' text-gray-500')}>
                  {displayText}
                </Text>
              </View>
              ...
              <View className=' flex-row'>
                <TouchableOpacity onPress={openPicker} >
                  <Icon name="calendar-alt" size={18} color={BaseColor.grayColor} />
                </TouchableOpacity>
                <TouchableOpacity className='ml-6'>
                  <Icon name="trash-alt" size={18} color={BaseColor.grayColor} onPress={()=>onChange(null)}/>
                </TouchableOpacity>
              </View>
